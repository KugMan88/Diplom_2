...
class TestApiCreateOrder:
    ...
    @allure.description('Получение ошибки при создании заказа без ингридиентов')
    ...
    @allure.description('Получение ошибки при попытке создать заказ с некорректными ингридиентами')
